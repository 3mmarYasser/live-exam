...
import AbstractModal from "../AbstractModal/AbstractModal.component.tsx";
import {PopType} from "../../reducers/pops/pops.interface.ts";
const  themes= [
    "light",
    "darkpurple",
    "bluebeard",
...
const ThemeModal = () => {
    ...
    return (
        <AbstractModal ModalType={PopType.ThemesMenu} className={" md:!w-11/12 md:!max-w-5xl"} >
        {(closeModal)=>(
        <div>
            <div className="mb-5">
