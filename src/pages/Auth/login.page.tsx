...
import UnAuthorizedRoute from "../../components/UnAuthorizedRoute/UnAuthorizedRoute.component.tsx";
            ...
            <div
                ...
                <div className="text-base-content min-h-screen">
                    <div>
                        ...
                        <div
                            className="relative flex min-h-screen items-center justify-center bg-[url(https://react.vristo.sbthemes.com/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat x-bg-base-100 px-6 py-10  sm:px-16">
                            ...
                            <div
                                className="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-base-100/60 backdrop-blur-lg  lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
